...
```
**Comment:**
From the distribution plot, we can easily find that the distribution of R Squared looks like a normal distribution but slightly left skewed. The log plot looks like more skewed to the normal distribution than R.
